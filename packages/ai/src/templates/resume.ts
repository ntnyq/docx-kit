...
/**
 * Generate a resume/CV DocxSchema from template parameters.
 *
 * Produces a document with name header, contact info,
 * summary, work experience, education, and skills sections.
 *
 * @param params - — Resume template parameters
